...
const capabilityRequirements: Record<CapabilityKey, { moduleKey?: string; featureFlags?: string[]; internalOnly?: boolean; permissions?: Array<{ resource: string; action: string }> }> = {
  ...
  'admin.console.view': { moduleKey: 'admin', internalOnly: true, permissions: [{ resource: 'admin_user', action: 'read' }] },
  ...
  'admin.knowledge.view': { moduleKey: 'admin', internalOnly: true, permissions: [{ resource: 'knowledge', action: 'read' }] },
  'admin.knowledge.manage': { moduleKey: 'admin', internalOnly: true, permissions: [{ resource: 'knowledge', action: 'update' }] },
  'admin.membership.view': { moduleKey: 'admin', internalOnly: true, permissions: [{ resource: 'admin_user', action: 'read' }] },
  'admin.membership.manage': { moduleKey: 'admin', internalOnly: true, permissions: [{ resource: 'admin_user', action: 'manage' }] },
  'admin.membership.notes.manage': { moduleKey: 'admin', internalOnly: true, permissions: [{ resource: 'admin_user', action: 'manage' }] },
  'admin.membership.override.manage': { moduleKey: 'admin', internalOnly: true, permissions: [{ resource: 'admin_user', action: 'manage' }] },
