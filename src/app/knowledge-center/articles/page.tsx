...
const articles = [
  ...
  {
    title: "A Deep Dive into Unit Economics for SaaS Businesses",
    description: "Understand the key metrics that drive profitability and growth for your SaaS company. Learn to calculate and optimize LTV, CAC, and more.",
    image: placeholderImages.articlesHero,
    category: "Finance",
    href: "#"
  }
];
      ...
      <section className="relative w-full pt-20 pb-12 md:pt-32 md:pb-20 lg:pt-40 lg:pb-28 bg-muted/40">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="mt-6 max-w-2xl mx-auto text-lg text-muted-foreground md:text-xl">
            In-depth articles and analysis on strategy, finance, and operations to help you grow your business.
          </p>
