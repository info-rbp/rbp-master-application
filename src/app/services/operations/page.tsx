...
export default async function ServicePage() {
  const content = await getServicePageBySlug('operations');

  return (
    <ManagedDetailPage
      title={content?.title ?? 'Operations Advisory'}
      description={content?.shortDescription ?? 'Create resilient and efficient operations foundations.'}
