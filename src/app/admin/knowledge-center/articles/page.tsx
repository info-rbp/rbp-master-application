...
export default async function AdminKnowledgeArticlesPage() {
  ...
  return <div className="flex-1 space-y-4 p-4 md:p-8 pt-6"><h2 className="text-3xl font-bold tracking-tight">Articles</h2><KnowledgeManager initial={entries} type="article" /></div>;
}
